...
<html lang="tr">
    <head>
        ...
        <title>@yield('title',$ayarlar->title)</title>
        ...
        <link rel="shortcut icon" href="{{$ayarlar->favicon}}" type="image/x-icon" />
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                ...
                <a class="navbar-brand" href="{{route('homepage')}}">
                    ...
                    <img src="{{$ayarlar->logo}}" width="150px" height="70px">
                </a>
                @else
                <a class="navbar-brand" href="{{route('homepage')}}">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        @foreach($pages as $p)
                         <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('pages.s',$p->slug)}}">{{$p->title}}</a></li>
                        @endforeach
